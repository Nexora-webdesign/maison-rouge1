...
export default function DemoNotice() {
  return (
    <section
      className="border-y border-gold/40 bg-grey-50 px-6 py-4 sm:py-5"
    ...
    >
      <div className="mx-auto flex max-w-[1100px] flex-col items-center gap-3 text-center sm:flex-row sm:justify-center sm:gap-5 sm:text-left">
        ...
        <div className="flex flex-col items-center sm:items-start">
          ...
          {/* Desktop / full line */}
          <p className="mt-1 hidden text-[0.9rem] leading-snug text-grey-600 sm:block">
            Diese Website ist ein Beispielprojekt. Namen, Bilder und Inhalte sind
            frei erfunden. So könnte deine eigene Website aussehen.
          </p>
          {/* Mobile / condensed line */}
          <p className="mt-1 block text-[0.9rem] leading-snug text-grey-600 sm:hidden">
          ...
          <a
            ...
            className="mt-2 inline-flex items-center font-medium text-[0.9rem] text-ink underline-offset-4 transition-colors hover:text-gold hover:underline"
          >
